  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass rounded-2xl p-10">
        ...
        <h2 className="mt-4 text-xl font-display text-foreground">Lost in the void</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This page slipped through the cracks of the ritual.
        </p>
        <div className="mt-6">
          <Link
            to="/"
...
function ErrorComponent({ error, reset }: { error: Error; reset: () => void }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center px-4">
      <div className="max-w-md text-center glass rounded-2xl p-10">
        <h1 className="text-xl font-display text-foreground">The ritual broke</h1>
        <p className="mt-2 text-sm text-muted-foreground">
          Something disturbed the energy. Try again or return home.
        </p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Resume Ritual — Beat the ATS" },
      {
        name: "description",
        content:
          "AI-powered resume matching for modern careers. Transform your resume into an ATS weapon.",
      },
      { property: "og:title", content: "Resume Ritual — Beat the ATS" },
      {
        property: "og:description",
        content: "AI-powered resume matching for modern careers.",
      },
